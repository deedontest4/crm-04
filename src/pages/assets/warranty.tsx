    ...
    <div className="h-screen flex flex-col overflow-hidden">
      <div className="flex-shrink-0 p-6 border-b">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Asset Warranty</h1>
            <p className="text-muted-foreground">Manage warranty records - {assetData?.asset_tag}</p>
          </div>
        </div>
      </div>
            ...
            <CardContent>
              <dl className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <dd className="text-sm mt-1">{assetData?.purchase_date || '-'}</dd>
                </div>
              </dl>
            </CardContent>
          </Card>

          <WarrantySection assetId={id || ""} />
        </div>
      </div>
    </div>
  );
