...
import { SoftwareLinksSection } from "./components/SoftwareLinksSection";
    ...
    <div className="h-screen flex flex-col overflow-hidden">
      <div className="flex-shrink-0 p-6 border-b">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Software Links</h1>
            <p className="text-muted-foreground">Manage software licenses - {assetData?.asset_tag}</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <SoftwareLinksSection assetId={id || ""} />
        </div>
      </div>
    </div>
  );
